exports.config = {
    ...
    //    './features/**/donor_loginExistingMobile.feature'
   // './features/**/attemptQuestionnnaire.feature'
   //    './features/**/RegressionCases_Android.feature'
      './features/**/codeAPill.feature'
                                                                    //'./features/**/*.feature'
    ],
    // Patterns to exclude.
    exclude: [
   ...
   //  Level of logging verbosity: trace | debug | info | warn | error | silent
    ...
    baseUrl: 'https://dev-dis-tec.onetakeda.com/DIS',
    //
...
//USe this as allure
    ...
    before () {
        ...
        browser.addCommand("waitForEnabledAndClick",async function () {
            // `this` is return value of $(selector)
    ...
    afterStep: async function (uri, feature, {error, result, duration, passed}, step) {
        var date = await  Date.now();
         await browser.saveScreenshot('./screenshots/DIS- '+date+'.png')
    },
